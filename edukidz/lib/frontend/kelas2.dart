...
import 'soalkelas2.dart';
import 'review2.dart';

class Kelas2Page extends StatefulWidget {
  const Kelas2Page({super.key});

  @override
  State<Kelas2Page> createState() => _Kelas2PageState();
}

class _Kelas2PageState extends State<Kelas2Page> with TickerProviderStateMixin {
                                    ...
                                    child: Container(
                                      ...
                                      child: ElevatedButton.icon(
                                        onPressed: () {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => const LatihanSoalKelas2()),
                                          );
                                        },
                                        style: ElevatedButton.styleFrom(
                                          backgroundColor: Colors.transparent,
