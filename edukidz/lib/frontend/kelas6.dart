...
import 'soalkelas6.dart';
import 'review6.dart';

class Kelas6Page extends StatefulWidget {
  const Kelas6Page({super.key});

  @override
  State<Kelas6Page> createState() => _Kelas6PageState();
}

class _Kelas6PageState extends State<Kelas6Page> with TickerProviderStateMixin {
                                    ...
                                    child: Container(
                                      ...
                                      child: ElevatedButton.icon(
                                        onPressed: () {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => const LatihanSoalPage6()),
                                          );
                                        },
                                        style: ElevatedButton.styleFrom(
                                          backgroundColor: Colors.transparent,
