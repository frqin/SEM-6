...
import 'soalkelas4.dart';
import 'review4.dart';

class Kelas4Page extends StatefulWidget {
  const Kelas4Page({super.key});

  @override
  State<Kelas4Page> createState() => _Kelas4PageState();
}

class _Kelas4PageState extends State<Kelas4Page> with TickerProviderStateMixin {
                                    ...
                                    child: Container(
                                      ...
                                      child: ElevatedButton.icon(
                                        onPressed: () {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => const LatihanSoalPage4()),
                                          );
                                        },
                                        style: ElevatedButton.styleFrom(
                                          backgroundColor: Colors.transparent,
