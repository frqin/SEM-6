...
import 'soalkelas5.dart';
import 'review5.dart';

class Kelas5Page extends StatefulWidget {
  const Kelas5Page({super.key});

  @override
  State<Kelas5Page> createState() => _Kelas5PageState();
}

class _Kelas5PageState extends State<Kelas5Page> with TickerProviderStateMixin {
                                    ...
                                    child: Container(
                                      ...
                                      child: ElevatedButton.icon(
                                        onPressed: () {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => const LatihanSoalPage5()),
                                          );
                                        },
                                        style: ElevatedButton.styleFrom(
                                          backgroundColor: Colors.transparent,
